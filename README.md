...
*   **Interactive Dashboard:** Provides an intuitive interface for real-time monitoring of order status, stock availability, and remaining customer credit limits.
...
```bash
   git clone https://github.com/Papichaya-Dev/salmon-allocation-system.git
   cd salmon-allocation-system
```
...
<img src="https://i.postimg.cc/MpBZHxPT/Screenshot-2569-06-01-at-22-49-39.png" alt="Salmon Allocation System Preview" width="600" />
</div>
